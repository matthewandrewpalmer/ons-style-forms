    ...
    return (
        <div className="page">
            <div className="page__content">
                ...
                <header className="header header--internal" role="banner">
                                ...
                                <div className="grid__col col-auto">
                                    <div className="header__logo--large">
                                        <svg className="ons-svg-logo" xmlns="http://www.w3.org/2000/svg" width="197"
                                            ...
                                            <path className="ons-svg-logo--accent"
                        ...
                        <div className="container">
                            <div
                                ...
                                <div className="grid__col col-auto u-flex-shrink">
                                    <div className="header__title">Service name</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer className="footer">
                <div className="footer__body page__footer" data-analytics="footer">
                    <div className="container">
                        <div className="grid">
                            <div className="grid__col u-mb-m">
                                <hr className="footer__hr"/>
                            </div>
                            <div className="grid__col">
                                <div className="footer__license">
                                    <svg className="footer__ogl-img" xmlns="http://www.w3.org/2000/svg" width="60px"
                                         height="24px" viewBox="0 0 60 24" focusable="false" aria-hidden="true">
                                        <path
                                    ...
                                    <a href="https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/"
                                       className="external-link" target="_blank" rel="noopener">Open Government Licence
                                        v3.0<span className="external-link__icon">&nbsp;
                                            <svg id="external-link" className="svg-icon" viewBox="0 0 12 12"
